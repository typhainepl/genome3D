...
pdbecursor.execute("select distinct(cathcode),class,arch,topol,homol from sifts_admin.CATH_DOMAIN");
...
pdbecursor.prepare("select name,source from sifts_admin.CATH_DOMAIN where domain= :domain")
